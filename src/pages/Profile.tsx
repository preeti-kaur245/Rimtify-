      ...
      <div className="bg-white rounded-3xl border border-zinc-200 overflow-hidden shadow-sm">
        ...
        <div className="px-8 pb-8">
          <div className="relative -mt-12 mb-6 flex items-end gap-6">
            ...
            <div className="pb-2">
              <h2 className="text-3xl font-bold text-zinc-900">{profile.name}</h2>
              <p className="text-zinc-500 font-medium">{profile.department} • {profile.university}</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <h3 className="text-xs font-bold text-zinc-400 uppercase tracking-widest">Academic Details</h3>
              ...
              <div className="bg-zinc-50 rounded-3xl p-8 border border-zinc-200">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-zinc-900">Anthropic API Key</h3>
                      <p className="text-xs text-zinc-500">Enable Claude AI features in Rimtify</p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="relative">
                    <input 
                      ...
                      className="w-full bg-white border-zinc-200 rounded-xl px-4 py-3 pr-12 focus:ring-2 focus:ring-orange-500 font-mono text-sm"
                    />
                  ...
                  <div className="flex items-start gap-3 p-4 bg-orange-50 rounded-2xl border border-orange-100">
                    ...
                    <p className="text-xs text-orange-800 leading-relaxed">
                      ...
                      If not provided, Rimtify will default to the integrated Gemini AI.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-end gap-4">
              {isSaved && (
                <span className="text-emerald-600 text-sm font-bold animate-in fade-in slide-in-from-right-4">
                  Changes saved successfully!
                </span>
              )}
              <button 
                type="submit"
                className="flex items-center gap-2 bg-zinc-900 text-white px-8 py-3 rounded-xl hover:bg-zinc-800 transition-all font-bold shadow-lg"
              >
                <Save size={20} />
                Save Profile
              </button>
